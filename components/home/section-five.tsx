  ...
  return (
    <section className="py-16">
      ...
      <div className="mx-auto bg-[#bedeb5] py-6 sm:px-8 px-4  md:px-20">
        ...
        <div className="flex items-center my-4 text-yellow-500 justify-center space-x-4">
